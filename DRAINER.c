...
sys.stdout.write("\x1b]2;DRAINER |DRAIN| DRAIN SKIDS\x07")
def modifications():
	print ("Contact DRAIN#0001 or the script is currently under maitnance")
...
info = """
[\033[91mSIN\033[00m] \033[91mMade By drain, most credit goes to a freind of mines whom taught me python
...
║ \033[00mExit                          \033[91m|\033[00m EXIT Drainer\033[91m         ║
║ \033[00mMethods                       \033[91m|\033[00m DRAIN METHODS\033[91m        ║
║ \033[00mTools                         \033[91m|\033[00m BASIC TOOLS\033[91m          ║
║ \033[00mUpdates                       \033[91m|\033[00m DISPLAY UPDATE NOTES\033[91m ║
║ \033[00mInfo                          \033[91m|\033[00m DISPLAY DrainerS INFO\033[91m║
╚══════════════════════════════════════════════════════╝\033[00m
"""
...
║ \033[00mStats                         \033[91m|\033[00m DISPLAY Drainer STATS\033[91m║
╚══════════════════════════════════════════════════════╝\033[00m
"""
...
altbanner = """
			      Angels go to heaven
                             Skids Go To Pits Of Hell
		      		  D R A I N E R 
"""

cookie = open(".Drainer_cookie","w+")
...
def main():
	...
	while True:
		sys.stdout.write("\x1b]2;D R A I N E R\x07")
		sin = input("\033[1;00m[\033[91mDrainer\033[1;00m]-\033[91m家\033[00m ").lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (altbanner)
			...
			sfound = 0
			sys.stdout.write("\x1b]2;D R A I N E R |{}| F O U N D\x07".format (sfound))
			try:
				host = sin.split(" ")[1]
				with open(r"/usr/share/Drainer/subnames.txt", "r") as sub:
			...
			try:
				...
				while True:
					try:
						...
						sys.stdout.write("\x1b]2;D R A I N E R |{}ms| D E M O N S\x07".format (stop))
						print ("Drainer: {}:{} | Time: {}ms [\033[91mUP\033[00m]".format(ip, port, stop))
						sock.close()
						time.sleep(1)
					except socket.error:
						sys.stdout.write("\x1b]2;D R A I N E R |TIME OUT| D E M O N S\x07")
						print ("Drainer: {}:{} [\033[91mDOWN\033[00m]".format(ip, port))
						time.sleep(1)
					except KeyboardInterrupt:
						print("")
						main()
